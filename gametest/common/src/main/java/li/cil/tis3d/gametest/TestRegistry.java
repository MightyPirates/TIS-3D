...
public final class TestRegistry {
    ...
    public static final RegistrySupplier<ModuleItem> TEST_MODULE_ITEM =
        ITEMS.register(TEST_MODULE_NAME, () -> new ModuleItem(new Item.Properties()
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(MOD_ID, TEST_MODULE_NAME)))));
