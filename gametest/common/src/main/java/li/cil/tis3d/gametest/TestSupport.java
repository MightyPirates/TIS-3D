...
public final class TestSupport {
    ...
    public static final String TEMPLATE_ID = MOD_ID + ":" + TEMPLATE;
    ...
    public static <T> T requireBlockEntity(final GameTestHelper helper, final BlockPos pos, final Class<T> type) {
        ...
        if (!type.isInstance(blockEntity)) {
            throw new GameTestAssertException(Component.literal("no " + type.getSimpleName() + " at " + pos + ", found " + blockEntity), 0);
        }
