...
import li.cil.tis3d.common.provider.ModuleProviderReadOnlyMemory;
...
import li.cil.tis3d.common.provider.ModuleProviderTerminal;
...
public class ProxyCommon {
    ...
    public void onInit(final FMLInitializationEvent event) {
        ...
        ModuleAPI.addProvider(new ModuleProviderReadOnlyMemory());
        ...
        ModuleAPI.addProvider(new ModuleProviderTerminal());
