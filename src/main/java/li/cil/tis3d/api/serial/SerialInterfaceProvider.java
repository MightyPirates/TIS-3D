...
public interface SerialInterfaceProvider {
     ...
     */
    boolean worksWith(World world, int x, int y, int z, EnumFacing side);
     ...
     */
    SerialInterface interfaceFor(World world, int x, int y, int z, EnumFacing side);
     ...
     * of serial interface that would be created via {@link #interfaceFor(World, int, int, int, EnumFacing)},
     ...
     */
    boolean isValid(World world, int x, int y, int z, EnumFacing side, SerialInterface serialInterface);
}
