...
@OnlyIn(Dist.CLIENT)
public final class ControllerTileEntityRenderer extends TileEntityRenderer<ControllerTileEntity> {
    public ControllerTileEntityRenderer(final TileEntityRendererDispatcher dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(final ControllerTileEntity controller, final float partialTicks, final MatrixStack matrixStack, final IRenderTypeBuffer bufferFactory, final int light, final int overlay) {
    ...
    private void renderState(final MatrixStack matrixStack, final IRenderTypeBuffer bufferFactory, final ControllerTileEntity.ControllerState state) {
