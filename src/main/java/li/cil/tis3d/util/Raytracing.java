...
public final class Raytracing {
     ...
     */
    @Nullable
    public static HitResult raytrace(final Level level, final Vec3 start, final Vec3 end, final CollisionDetector callback) {
        ...
        while (--emergencyExit > 0) {
            ...
            final HitResult hit = callback.intersect(level, position, start, end);
