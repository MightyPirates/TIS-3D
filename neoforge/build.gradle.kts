...
loom {
    ...
    runs {
        ...
        create("gameTestServer") {
            ...
            systemProperties.put("neoforge.enabledGameTestNamespaces", "tis3d_gametest")
            systemProperties.put("tis3d.gameTest.junitDir", gameTestResultsDir.get().asFile.absolutePath)
            jvmArguments.add("-ea")
        }
