...
public interface ModuleWithBakedModelFabric extends ModuleWithBakedModel {
    ...
    void emitBlockQuads(final BlockAndTintGetter blockView, final BlockState state, final BlockPos pos, final Direction direction, final RandomSource random, final QuadEmitter emitter);
}
