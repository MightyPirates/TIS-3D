...
public final class CommonConfig {
    ...
    @Comment("The maximum number of instructions an ASM program for an execution node may have. Comments, defines, labels and blank lines do not count. Use zero to remove the limit.")
